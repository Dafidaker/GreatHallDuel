...
var player_id = null
var playerdk = {}
let playerif = {mana: 0 , mana_total:0, health:20, energy:3, num: null }
let enemyif = {mana: 0 , mana_total:0, health:20, energy:3 , num: null}
var playerinfo;
var AllPlays
var Plays = {}
var MaxPlays = 0 
...
var RoomNum = null
var Round = {State : 0 , Number: 0 , String: '[Waiting for information ...]'}
...
///////////////////////////////////////////////////
    //Update function//
        updateME();
        //setInterval(InicialInformation(),5000);
}   
...
function draw_hud(){ 
    ...
    textSize(45)
    fill(0, 0, 0)
    text(Round.String,(canvasx/2)-(textWidth(Round.String)/2) ,canvasy * 0.07 + (canvasy * 0.07/2))
...
async function getBattleRoundclient(){
...
async function getplayerinformationclient(){
    getplayerinformation(1)
    
}

async function ChangePlayerInfoclient(){
    ChangePlayerInfo(1,18,4,4,3)
}

async function getplayerdeckclient(){
    getplayerdeck(1)
}

async function getplayerspositionclient(){
    getplayersposition(1)
}

async function ChangePlayerPositionclient(){
    ChangePlayerPosition(1,57)
}

async function Playclient(){
    Play(1,1,7,150,2,2,2)
}

async function GetPlaysclient(){
    GetPlays(1)
}
